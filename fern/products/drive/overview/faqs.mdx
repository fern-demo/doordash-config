...
## What is the DoorDash Developer Portal? [#what-is-the-doordash-developer-portal]
...
## What is DoorDash Drive? [#what-is-doordash-drive]
...
## What are the differences between DoorDash Drive and DoorDash Marketplace? [#what-are-the-differences-between-doordash-drive-and-doordash-marketplace]
...
## What countries does DoorDash Drive operate in? [#what-countries-does-doordash-drive-operate-in]
...
## Who can create a developer account? [#who-can-create-a-developer-account]
...
## Does every member of my development team need to create their own account? [#does-every-member-of-my-development-team-need-to-create-their-own-account]
...
## How do I know if I'm building to Drive vs. Drive Classic? What's the difference? [#how-do-i-know-if-im-building-to-drive-vs-drive-classic-whats-the-difference]
...
## How long does it take to build an integration to DoorDash? [#how-long-does-it-take-to-build-an-integration-to-doordash]
...
## Are there items that cannot be delivered through DoorDash? [#are-there-items-that-cannot-be-delivered-through-doordash]
...
## Will I have to sign a contract to integrate with Drive? [#will-i-have-to-sign-a-contract-to-integrate-with-drive]
...
## Is delivery tracking available? [#is-delivery-tracking-available]

Yes, DoorDash supplies a tracking link for each delivery that you can expose within your UI.

## What is UTC vs. Local Time Zones? [#what-is-utc-vs-local-time-zones]

UTC is 8 hours ahead of PST, 7 MST, 6 CST and 5 EST

## How will I be notified of service disruption? [#how-will-i-be-notified-of-service-disruption]
...
## Do you have rate limits? [#do-you-have-rate-limits]
...
## Will DoorDash refund me if the delivery is late? [#will-doordash-refund-me-if-the-delivery-is-late]
...
## Who delivers items via DoorDash? [#who-delivers-items-via-doordash]
