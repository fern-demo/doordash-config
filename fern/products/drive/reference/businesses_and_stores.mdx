...
### Business[​](#business "Direct link to heading")
...
#### External Business Identifiers[​](#external-business-identifiers "Direct link to heading")
...
## The default business & store[​](#the-default-business--store "Direct link to heading")
...
## Why you should create businesses and stores[​](#why-you-should-create-businesses-and-stores "Direct link to heading")

### Improved delivery quality[​](#improved-delivery-quality "Direct link to heading")
...
### Peace of mind[​](#peace-of-mind "Direct link to heading")
...
### Clear invoices[​](#clear-invoices "Direct link to heading")
...
### Better support experiences[​](#better-support-experiences "Direct link to heading")
...
### Access to leads from DoorDash marketing sites[​](#access-to-leads-from-doordash-marketing-sites "Direct link to heading")
...
### Self-serve access to new delivery capabilities[​](#self-serve-access-to-new-delivery-capabilities "Direct link to heading")
...
## Example business & store scenarios[​](#example-business--store-scenarios "Direct link to heading")

### Merchant[​](#merchant "Direct link to heading")
...
### Platform/middleware provider[​](#platformmiddleware-provider "Direct link to heading")
...
## When you should create businesses & stores[​](#when-you-should-create-businesses--stores "Direct link to heading")
