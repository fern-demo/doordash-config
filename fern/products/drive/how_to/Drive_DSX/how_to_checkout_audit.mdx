...
### Checkout Barcode / QR Code Enablement[​](#checkout-barcode--qr-code-enablement "Direct link to heading")
...
### Audit API[​](#audit-api "Direct link to heading")
...
**Request Body Schema**
[https://developer.doordash.com/en-US/api/drive#tag/Audit/operation/CheckoutAuditSignal](https://developer.doordash.com/en-US/api/drive#tag/Audit/operation/CheckoutAuditSignal)
