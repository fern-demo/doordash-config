...
## 2. Map your data model to DoorDash's data model[​](#2-map-your-data-model-to-doordashs-data-model "Direct link to heading")
...
## 3. Create a business[​](#3-create-a-business "Direct link to heading")
...
## 4. Create a store[​](#4-create-a-store "Direct link to heading")
...
## 5. Create a delivery[​](#5-create-a-delivery "Direct link to heading")
