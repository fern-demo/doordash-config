...
## 2. Create a delivery that requires signature[​](#2-create-a-delivery-that-requires-signature "Direct link to heading")
...
## 3. Receive signature images[​](#3-receive-signature-images "Direct link to heading")
