...
## 2. Create a delivery with pickup information[​](#2-create-a-delivery-with-pickup-information "Direct link to heading")
...
## 3. Create a delivery with dropoff information[​](#3-create-a-delivery-with-dropoff-information "Direct link to heading")
