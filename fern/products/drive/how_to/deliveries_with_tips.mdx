...
## 2. Collect a tip from the customer during payment [#2-collect-a-tip-from-the-customer-during-payment]
...
## 3. Create a delivery with tips [#3-create-a-delivery-with-tips]
...
## 4. Review with DoorDash [#4-review-with-doordash]
