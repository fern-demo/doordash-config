...
##### Key ID and Signing Secret [#key-id-and-signing-secret]
...
##### Default Pickup Instructions [#default-pickup-instructions]
...
##### Delivery Fees Mode [#delivery-fees-mode]
...
#### DoorDasher Tipping [#doordasher-tipping]
