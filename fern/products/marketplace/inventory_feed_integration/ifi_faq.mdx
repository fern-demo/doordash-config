...
### What if I can’t use SFTP? [#what-if-i-cant-use-sftp]
...
### Can I encrypt my file? [#can-i-encrypt-my-file]
...
### What items are restricted from DoorDash? [#what-items-are-restricted-from-doordash]
...
### How many items are required? [#how-many-items-are-required]
...
### Do I need to provide Catalog images? [#do-i-need-to-provide-catalog-images]
...
### What are the standards for images I provide? [#what-are-the-standards-for-images-i-provide]
...
### Is there an image coverage threshold? [#is-there-an-image-coverage-threshold]
...
### Are catalog updates automated? [#are-catalog-updates-automated]
...
### If a new SKU is added to our catalog file or our Inventory Feed, how long until it appears on DoorDash? [#if-a-new-sku-is-added-to-our-catalog-file-or-our-inventory-feed-how-long-until-it-appears-on-doordash]
...
### How do Weighted Items work? [#how-do-weighted-items-work]
...
### I see an error in our catalog on DoorDash. What do I do? [#i-see-an-error-in-our-catalog-on-doordash-what-do-i-do]
...
### The item names on DoorDash differ from that on our site. Why is this? [#the-item-names-on-doordash-differ-from-that-on-our-site-why-is-this]
...
### DoorDash Taxonomy is different from our taxonomy. Why is this? [#doordash-taxonomy-is-different-from-our-taxonomy-why-is-this]
...
### What are these merchandising carousels? Can we change them? [#what-are-these-merchandising-carousels-can-we-change-them]
...
### How does the overall catalog building process work? [#how-does-the-overall-catalog-building-process-work]
...
### What kind of UPC should I provide? [#what-kind-of-upc-should-i-provide]
...
### Do I need to use a dated folder when transferring my Inventory Feed File? [#do-i-need-to-use-a-dated-folder-when-transferring-my-inventory-feed-file]

If all stores are included in a single daily file, creating a dynamic daily folder is unnecessary.

### What time of day is best to share my Inventory Feed File? [#what-time-of-day-is-best-to-share-my-inventory-feed-file]
...
### What if I don’t have item-level taxes? [#what-if-i-dont-have-item-level-taxes]
...
### Can I customize DoorDash Standard Reports to my system needs? [#can-i-customize-doordash-standard-reports-to-my-system-needs]
...
### How can I review transactions on my DoorDash Marketplace Store? [#how-can-i-review-transactions-on-my-doordash-marketplace-store]
