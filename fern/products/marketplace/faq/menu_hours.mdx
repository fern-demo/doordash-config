...
## What timezone should my ‘start\_time’ and ‘end\_time’ be?[​](#what-timezone-should-my-start_time-and-end_time-be "Direct link to heading")

The hours should be set based on the timezone of the restaurant/store.

## How can I send hours if my store is open overnight?[​](#how-can-i-send-hours-if-my-store-is-open-overnight "Direct link to heading")
...
## How can I send hours if my store is open 24/7?[​](#how-can-i-send-hours-if-my-store-is-open-247 "Direct link to heading")

For specific information on how to configure the store hour fields, please refer to our [Menu Configuration Reference](https://developer.doordash.com/en-US/docs/marketplace/explainers/menu_configuration_reference#hours).

## What causes a menu job to fail due to store hours?[​](#what-causes-a-menu-job-to-fail-due-to-store-hours "Direct link to heading")
...
## How can I send hours if my store is closed?[​](#how-can-i-send-hours-if-my-store-is-closed "Direct link to heading")
...
## Why is my store on DoorDash closing earlier than the hours sent?[​](#why-is-my-store-on-doordash-closing-earlier-than-the-hours-sent "Direct link to heading")
...
## Can I set hours for a specific item?[​](#can-i-set-hours-for-a-specific-item "Direct link to heading")
...
## How can I set multiple open hour periods within the same day (mid-day closure)?[​](#how-can-i-set-multiple-open-hour-periods-within-the-same-day-mid-day-closure "Direct link to heading")
