...
## Where can I find sample order data?[​](#where-can-i-find-sample-order-data "Direct link to heading")

[Sample order data](/en-US/docs/marketplace/reference/sample_order)

## What is a POS Order Error?[​](#what-is-a-pos-order-error "Direct link to heading")
...
## How can I tell the difference between a Customer Pickup Order and a regular Dasher Delivery Order?[​](#how-can-i-tell-the-difference-between-a-customer-pickup-order-and-a-regular-dasher-delivery-order "Direct link to heading")
...
## How can I tell the difference between a Dasher Fulfilled Order and a Self Delivery (Merchant Delivered) Order?[​](#how-can-i-tell-the-difference-between-a-dasher-fulfilled-order-and-a-self-delivery-merchant-delivered-order "Direct link to heading")
...
## Is there a maximum order size (basket size)?[​](#is-there-a-maximum-order-size-basket-size "Direct link to heading")
...
## Is there a minimum dollar amount for an order?[​](#is-there-a-minimum-dollar-amount-for-an-order "Direct link to heading")
...
## How do scheduled orders work?[​](#how-do-scheduled-orders-work "Direct link to heading")
...
## Can we accept orders via Tablet with OpenAPI integration?[​](#can-we-accept-orders-via-tablet-with-openapi-integration "Direct link to heading")
...
## If a store has multiple menus, is there a way to know which menu the order is from?[​](#if-a-store-has-multiple-menus-is-there-a-way-to-know-which-menu-the-order-is-from "Direct link to heading")

Currently there is no flag on the order payload that notates the menu that an order was ordered from.

## How can I enable the Order Cancellation Notification webhook?[​](#how-can-i-enable-the-order-cancellation-notification-webhook "Direct link to heading")
...
## How does Auto Release work for pickup orders?[​](#how-does-auto-release-work-for-pickup-orders "Direct link to heading")
...
## Will DoorDash ever retry the order POST if it is not successfully processed by the partner?[​](#will-doordash-ever-retry-the-order-post-if-it-is-not-successfully-processed-by-the-partner "Direct link to heading")
...
## For asynchronous order confirmation, is any sort of payload body required in the initial response?[​](#for-asynchronous-order-confirmation-is-any-sort-of-payload-body-required-in-the-initial-response "Direct link to heading")
...
## How is the price of an item communicated in the order payload?[​](#how-is-the-price-of-an-item-communicated-in-the-order-payload "Direct link to heading")
...
## How can I tell if the order was placed on Doordash, Caviar or Storefront?[​](#how-can-i-tell-if-the-order-was-placed-on-doordash-caviar-or-storefront "Direct link to heading")

There is a field on the order payload called `experience` which indicates which platform the order was placed on.

## How can I tell if a customer tipped on an order?[​](#how-can-i-tell-if-a-customer-tipped-on-an-order "Direct link to heading")
...
## How are promotions sent on the order?[​](#how-are-promotions-sent-on-the-order "Direct link to heading")
...
## How do customer cancellations work?[​](#how-do-customer-cancellations-work "Direct link to heading")
...
## Should merchants manually accept or fail orders with a POS Integration?[​](#should-merchants-manually-accept-or-fail-orders-with-a-pos-integration "Direct link to heading")
...
## How can I contact the customer about their order?[​](#how-can-i-contact-the-customer-about-their-order "Direct link to heading")
...
## What’s the time window in which the store operator can contact the customer?[​](#whats-the-time-window-in-which-the-store-operator-can-contact-the-customer "Direct link to heading")
...
## Can store operators make masked custom calls crossing international borders?[​](#can-store-operators-make-masked-custom-calls-crossing-international-borders "Direct link to heading")

This is not possible, both the store and the customer must be using the same international country codes.

## What phone number does DoorDash have for my store(s)?[​](#what-phone-number-does-doordash-have-for-my-stores "Direct link to heading")
...
## Can I still contact DoorDash Support via the support phone number?[​](#can-i-still-contact-doordash-support-via-the-support-phone-number "Direct link to heading")
