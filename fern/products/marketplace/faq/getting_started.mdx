...
## What is my Provider Type?[​](#what-is-my-provider-type "Direct link to heading")
...
## What are the URL root details?[​](#what-are-the-url-root-details "Direct link to heading")

Marketplace API: URL root is [https://openapi.doordash.com/marketplace/](https://openapi.doordash.com/marketplace/) for all calls.

## How can I tell which API (Marketplace vs. Drive) I'm using?[​](#how-can-i-tell-which-api-marketplace-vs-drive-im-using "Direct link to heading")
...
## Can we control integration type (moving from POS to Tablet, etc.)?[​](#can-we-control-integration-type-moving-from-pos-to-tablet-etc "Direct link to heading")
...
## How do I switch the provider\_type for a store?[​](#how-do-i-switch-the-provider_type-for-a-store "Direct link to heading")

Submit a request to your Doordash representative to get the provider\_type updated.

## Are there other APIs available from DoorDash?[​](#are-there-other-apis-available-from-doordash "Direct link to heading")
...
## Why does the Merchant Portal say our integration doesn’t support certain features we actually do?[​](#why-does-the-merchant-portal-say-our-integration-doesnt-support-certain-features-we-actually-do "Direct link to heading")
