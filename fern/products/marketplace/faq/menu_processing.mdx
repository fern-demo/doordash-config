...
## What is ‘reference’ referring to?[​](#what-is-reference-referring-to "Direct link to heading")
...
## What is returned for menu.id when MenuCreate fails?[​](#what-is-returned-for-menuid-when-menucreate-fails "Direct link to heading")
...
## How long should I wait for a Menu Status Update Notification before retrying a menu?[​](#how-long-should-i-wait-for-a-menu-status-update-notification-before-retrying-a-menu "Direct link to heading")
