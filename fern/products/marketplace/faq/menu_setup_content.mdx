...
## Where can I see sample configurations for a menu?​[​](#where-can-i-see-sample-configurations-for-a-menu "Direct link to heading")
...
## Is there a max menu size that will be accepted?[​](#is-there-a-max-menu-size-that-will-be-accepted "Direct link to heading")

We can successfully process menus with a file size up to 25MB.

## How is the “Most Popular” section populated?​[​](#how-is-the-most-popular-section-populated "Direct link to heading")

This section is populated based on a calculation by DoorDash via Machine Learning and an item’s order history.

## How do I control the status of a menu?​[​](#how-do-i-control-the-status-of-a-menu "Direct link to heading")
...
## What is the difference between price and base\_price?[​](#what-is-the-difference-between-price-and-base_price "Direct link to heading")
...
## What is an Item / Extra / Option?[​](#what-is-an-item--extra--option "Direct link to heading")
...
## How do I specify a tax rate?[​](#how-do-i-specify-a-tax-rate "Direct link to heading")
...
## Will DoorDash respect my tax rates sent for Merchants in MPF states?[​](#will-doordash-respect-my-tax-rates-sent-for-merchants-in-mpf-states "Direct link to heading")

No, DoorDash will ignore what is sent and we will calculate our own tax.

## Where can I find a list of Marketplace Facilitator states?[​](#where-can-i-find-a-list-of-marketplace-facilitator-states "Direct link to heading")
...
## Does DoorDash’s tax engine include surcharges such as sugary-drink tax and bottle deposits?[​](#does-doordashs-tax-engine-include-surcharges-such-as-sugary-drink-tax-and-bottle-deposits "Direct link to heading")
...
## How do I create a default itemOption?[​](#how-do-i-create-a-default-itemoption "Direct link to heading")
...
## If I don’t want to use a field, can I use a null value?[​](#if-i-dont-want-to-use-a-field-can-i-use-a-null-value "Direct link to heading")
...
## How are Categories Sorted?[​](#how-are-categories-sorted "Direct link to heading")
...
## Can I set a price upcharge for a modifier that is a Quantity Selector?[​](#can-i-set-a-price-upcharge-for-a-modifier-that-is-a-quantity-selector "Direct link to heading")
...
## How do I maintain multiple menus (day parting)?[​](#how-do-i-maintain-multiple-menus-day-parting "Direct link to heading")
...
## Can I sell alcohol on my DoorDash menu?[​](#can-i-sell-alcohol-on-my-doordash-menu "Direct link to heading")
...
## Can merchants edit their menu in DoorDash?[​](#can-merchants-edit-their-menu-in-doordash "Direct link to heading")
...
### Sticky Values[​](#sticky-values "Direct link to heading")
...
### Override Values[​](#override-values "Direct link to heading")
