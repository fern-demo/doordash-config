...
3. If merchant exists on DoorDash, merchant is prompted to “login with DoorDash” via oAuth.
...
Within your surface to activate their integration, ensure the Merchant understands that if they’re new to DoorDash, clicking ‘Activate’ (or completing SSIO) will also result in their store being activated
...
No. To ensure the Merchant is one controlling their store activation, we’ve limited this automation to SSIO only.
...
| mx\_decision\_maker\_email | string | true | Email contact for user on the merchant’s side initiating the request as well as for receiving status updates on the onboarding request |

## Prerequisites & Other Requirements  [#prerequisites--other-requirements]

---

#### [Prerequisite] Developer Portal Sign Up & Technical Migration [#prerequisite-developer-portal-sign-up--technical-migration]
...
#### [Requirement] Integration Transitioning Merchants [#requirement-integration-transitioning-merchants]
...
#### [Requirement] Ingest New Onboarding ID [#requirement-ingest-new-onboarding-id]
...
#### [Requirement] Partner Environment URL [#requirement-partner-environment-url]
...
#### [Requirement] SSIO Restart [#requirement-ssio-restart]
...
#### [Requirement] Partner-created Help Article [#requirement-partner-created-help-article]
...
#### [FYI] Launch Timeline [#fyi-launch-timeline]
...
#### DoorDash Provides the Following to Partners: [#doordash-provides-the-following-to-partners]
...
#### Partner Provides the Following to DoorDash: [#partner-provides-the-following-to-doordash]
