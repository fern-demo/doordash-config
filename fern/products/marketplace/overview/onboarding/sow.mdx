...
### Request Endpoint[​](#request-endpoint "Direct link to heading")
...
### Onboarding Status[​](#onboarding-status "Direct link to heading")
...
### Possible Exclusion Code Values[​](#possible-exclusion-code-values "Direct link to heading")
...
## Merchant Communication Details[​](#merchant-communication-details "Direct link to heading")
...
#### [Prerequisite] Menu Pull[​](#prerequisite-menu-pull "Direct link to heading")
...
#### [Requirement] Real-time Menu Updates[​](#requirement-real-time-menu-updates "Direct link to heading")
...
#### [Requirement] Partner SLA[​](#requirement-partner-sla "Direct link to heading")
...
#### [FYI] Staff Tips[​](#fyi-staff-tips "Direct link to heading")
...
## Specification Updates[​](#specification-updates "Direct link to heading")
