## Introducing DoorDash Preferred Integrations Program (DPIP) [#introducing-doordash-preferred-integrations-program-dpip]
...
### Achieving "Preferred Integrations" Status [#achieving-preferred-integrations-status]
...
### What does my quality status mean? [#what-does-my-quality-status-mean]
...
### Why am I at risk of suspension? [#why-am-i-at-risk-of-suspension]
...
### What happens if I'm at risk of suspension? [#what-happens-if-im-at-risk-of-suspension]
...
### What happens if I'm suspended? [#what-happens-if-im-suspended]
...
### Can suspension be reversed? [#can-suspension-be-reversed]
...
### When do suspensions begin? [#when-do-suspensions-begin]
...
### How do I earn a DoorDash Preferred Integration rating? [#how-do-i-earn-a-doordash-preferred-integration-rating]
...
### Can my quality status change over time? [#can-my-quality-status-change-over-time]
...
### How did you pick these performance standards and features? [#how-did-you-pick-these-performance-standards-and-features]
...
### What order are providers listed in on the DPIP webpage? [#what-order-are-providers-listed-in-on-the-dpip-webpage]
...
### How did you calculate my integration maturity? [#how-did-you-calculate-my-integration-maturity]
...
### What does it mean to "support" a high-quality feature? [#what-does-it-mean-to-support-a-high-quality-feature]
...
### What does my performance rating on the DPIP page mean? [#what-does-my-performance-rating-on-the-dpip-page-mean]
...
### Will DoorDash Preferred Integration requirements change? [#will-doordash-preferred-integration-requirements-change]
...
### How do merchants refer to minimum performance standards and high-quality features? [#how-do-merchants-refer-to-minimum-performance-standards-and-high-quality-features]
...
### Why is my integration not displayed on the webpage? [#why-is-my-integration-not-displayed-on-the-webpage]
