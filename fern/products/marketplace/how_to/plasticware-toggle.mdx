...
### Step 1: Confirm your [Webhook Subscription setup](https://developer.doordash.com/portal/integration/marketplace/webhook_subscriptions) is complete[​](#step-1-confirm-your-webhook-subscription-setup-is-complete "Direct link to heading")

Verify the Endpoint URL defined for the “Orders” Event Type.


### Step 2: Identify the order payload model and the additional field **"is\_plastic\_ware\_option\_selected"**.[​](#step-2-identify-the-order-payload-model-and-the-additional-field-is_plastic_ware_option_selected "Direct link to heading")

### Step 3: Upon order injection, validate the field **"is\_plastic\_ware\_option\_selected"**[​](#step-3-upon-order-injection-validate-the-field-is_plastic_ware_option_selected "Direct link to heading")
...
### Step 1 - POS Programming[​](#step-1---pos-programming "Direct link to heading")
...
### Step 2 - User Acceptance Testing[​](#step-2---user-acceptance-testing "Direct link to heading")
...
### Step 3 - Deployment Planning[​](#step-3---deployment-planning "Direct link to heading")
...
### Step 4 - Complete Rollout[​](#step-4---complete-rollout "Direct link to heading")

Ensure that functionality is enabled for all eligible stores under your provider.

## FAQs[​](#faqs "Direct link to heading")

### Why is DoorDash rolling out this new policy?[​](#why-is-doordash-rolling-out-this-new-policy "Direct link to heading")
...
### What do you mean by “plasticware”?[​](#what-do-you-mean-by-plasticware "Direct link to heading")
...
### How will consumers select whether or not to include silverware?[​](#how-will-consumers-select-whether-or-not-to-include-silverware "Direct link to heading")
...
### Will Dashers know about this change?[​](#will-dashers-know-about-this-change "Direct link to heading")
...
### Where does this new DoorDash program apply?[​](#where-does-this-new-doordash-program-apply "Direct link to heading")
...
### If I don’t provide any silverware today, do I need to start?[​](#if-i-dont-provide-any-silverware-today-do-i-need-to-start "Direct link to heading")
