...
### Example Order[​](#example-order "Direct link to heading")
...
#### Sample order with subtotal level discount[​](#sample-order-with-subtotal-level-discount "Direct link to heading")
...
#### Sample order with item level discount[​](#sample-order-with-item-level-discount "Direct link to heading")
...
#### Sample order without discount[​](#sample-order-without-discount "Direct link to heading")
