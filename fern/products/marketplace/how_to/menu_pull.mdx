...
### Step 1: Set up Endpoint Specification to Pull Menus[​](#step-1-set-up-endpoint-specification-to-pull-menus "Direct link to heading")
...
### Step 3: Allow Menu Pull to be used for Menu updates[​](#step-3-allow-menu-pull-to-be-used-for-menu-updates "Direct link to heading")
...
## Auto Menu Pull[​](#auto-menu-pull "Direct link to heading")
...
### Key Benefits[​](#key-benefits "Direct link to heading")
...
### Configuration & Dependencies[​](#configuration--dependencies "Direct link to heading")
