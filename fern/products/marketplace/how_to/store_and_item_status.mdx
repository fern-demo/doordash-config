...
## Store activation status change[​](#store-activation-status-change "Direct link to heading")
...
## Retrieving Store Info (GET)[​](#retrieving-store-info-get "Direct link to heading")
...
## Retrieving Store Menu Details (GET)[​](#retrieving-store-menu-details-get "Direct link to heading")
...
## Using the store status webhook function to reduce avoidable cancellations[​](#using-the-store-status-webhook-function-to-reduce-avoidable-cancellations "Direct link to heading")
