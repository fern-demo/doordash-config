## Using the Store Status Webhook Function[​](#using-the-store-status-webhook-function "Direct link to heading")

### The Challenge[​](#the-challenge "Direct link to heading")
...
### What are Avoidable Cancellations?[​](#what-are-avoidable-cancellations "Direct link to heading")
...
### The Results[​](#the-results "Direct link to heading")
