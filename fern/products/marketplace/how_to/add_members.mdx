...
## 1. Navigate to the members list [#1-navigate-to-the-members-list]
...
## 2. Start adding a member [#2-start-adding-a-member]

Click the Add Member button to start adding a member.



## 3. Enter the member's details [#3-enter-the-members-details]
...
## Member is added [#member-is-added]
