...
### Step 1: Enable Bag Fee at Checkout[​](#step-1-enable-bag-fee-at-checkout "Direct link to heading")
...
### Step 2: Implement - Order Payload[​](#step-2-implement---order-payload "Direct link to heading")
...
## Next Steps - FAQ[​](#next-steps---faq "Direct link to heading")
