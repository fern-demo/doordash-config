...
## Developer Test Order Walkthrough [#developer-test-order-walkthrough]

### Step 1: Navigate to Stores within Developer Portal [#step-1-navigate-to-stores-within-developer-portal]
...
### Step 2: Create and Copy Login Link [#step-2-create-and-copy-login-link]
...
### Step 3: Open Link and Create Order [#step-3-open-link-and-create-order]
...
### Step 4: Add Test Credit Card Credentials [#step-4-add-test-credit-card-credentials]
...
### Step 5: Place Order [#step-5-place-order]
...
### Step 6: Progress Check [#step-6-progress-check]
...
## Merchant Test Order Walkthrough [#merchant-test-order-walkthrough]
...
### Step 1: Access Your Test Store [#step-1-access-your-test-store]
...
### Step 3: Add Items to Your Cart [#step-3-add-items-to-your-cart]
...
### Step 4: Proceed to Checkout & Add Payment [#step-4-proceed-to-checkout--add-payment]
...
### Step 5: Place the Test Order [#step-5-place-the-test-order]
...
### Step 6: Monitor Order Progress [#step-6-monitor-order-progress]
