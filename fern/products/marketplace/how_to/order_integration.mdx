...
## Receiving Orders from DoorDash[​](#receiving-orders-from-doordash "Direct link to heading")
...
## Notable Fields[​](#notable-fields "Direct link to heading")
...
## Confirming Orders[​](#confirming-orders "Direct link to heading")
...
### Synchronous Order Confirmation[​](#synchronous-order-confirmation "Direct link to heading")
...
### Asynchronous Order Confirmation[​](#asynchronous-order-confirmation "Direct link to heading")
...
## Notable Fields[​](#notable-fields-1 "Direct link to heading")
...
## Auto Order Release (AOR)[​](#auto-order-release-aor "Direct link to heading")
...
## Order Event Updates[​](#order-event-updates "Direct link to heading")
...
## Order Failures - Required Failure Reasons[​](#order-failures---required-failure-reasons "Direct link to heading")
...
### Store Closed Failure Reasons[​](#store-closed-failure-reasons "Direct link to heading")
...
### Store Open but Unavailable for POS Orders Failure Reasons[​](#store-open-but-unavailable-for-pos-orders-failure-reasons "Direct link to heading")
...
### Item out of stock Failure Reasons[​](#item-out-of-stock-failure-reasons "Direct link to heading")
...
### Menu data mismatch/out of sync Failure Reasons[​](#menu-data-mismatchout-of-sync-failure-reasons "Direct link to heading")
...
## Post Order Confirmation Updates[​](#post-order-confirmation-updates "Direct link to heading")
