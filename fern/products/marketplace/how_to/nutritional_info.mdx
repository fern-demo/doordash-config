...
### Step 1: Alter Menu Payload [#step-1-alter-menu-payload]

Alter menu payload to add desired nutritional information on an item OR item modifier level.

#### Add Caloric Information to Menu Payload: [#add-caloric-information-to-menu-payload]
...
##### Caloric Info JSON Snippet Example: [#caloric-info-json-snippet-example]
...
#### Add Dietary Tags to Menu Payload: [#add-dietary-tags-to-menu-payload]
...
##### Dietary Tags JSON Snippet Example: [#dietary-tags-json-snippet-example]
...
### Step 2: Push Menu with new additional fields and validate in UI [#step-2-push-menu-with-new-additional-fields-and-validate-in-ui]
...
## Menu Payload Example: [#menu-payload-example]
