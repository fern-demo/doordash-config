...
### What is Order Ready Signal?[​](#what-is-order-ready-signal "Direct link to heading")
...
### Why Implement Order Ready Signal?[​](#why-implement-order-ready-signal "Direct link to heading")
...
### What makes a successful Order Ready Signal launch?[​](#what-makes-a-successful-order-ready-signal-launch "Direct link to heading")
...
#### Step 1: Receive an order[​](#step-1-receive-an-order "Direct link to heading")
...
#### Step 2: Notify DoorDash the order is ready[​](#step-2-notify-doordash-the-order-is-ready "Direct link to heading")
