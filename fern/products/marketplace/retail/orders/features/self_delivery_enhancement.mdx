...
### Step 2: Understand the event types[​](#step-2-understand-the-event-types "Direct link to heading")
...
### Step 3: Understand the possible webhook fields[​](#step-3-understand-the-possible-webhook-fields "Direct link to heading")
...
### Step 4: Implement[​](#step-4-implement "Direct link to heading")

Route order to the endpoint using the specified format.

#### Update with status `ORDER_READY_FOR_PICKUP` or `ORDER_DELIVERED`[​](#update-with-status-order_ready_for_pickup-or-order_delivered "Direct link to heading")
...
#### Update with status `ORDER_PICKED_UP` or `ORDER_IS_ARRIVING`[​](#update-with-status-order_picked_up-or-order_is_arriving "Direct link to heading")
