...
### Step 1: Set up your [Webhook Subscription](https://developer.doordash.com/portal/integration/marketplace/webhook_subscriptions)[​](#step-1-set-up-your-webhook-subscription "Direct link to heading")

Make sure to use the `"Dasher Status Updates"` event type


### Step 2: Understand the Webhook Fields[​](#step-2-understand-the-webhook-fields "Direct link to heading")
...
### Step 3: Set up the Webhook Payload[​](#step-3-set-up-the-webhook-payload "Direct link to heading")
...
### Step 4: Understand the Response & Error Codes[​](#step-4-understand-the-response--error-codes "Direct link to heading")
