...
## Mission[​](#mission "Direct link to heading")
...
## Key Terms[​](#key-terms "Direct link to heading")
...
## Steps to Build API Integration[​](#steps-to-build-api-integration "Direct link to heading")
...
### Catalog Integration[​](#catalog-integration "Direct link to heading")
...
#### Catalog Pull [REQUIRED][​](#catalog-pull-required "Direct link to heading")
...
### Inventory Integration[​](#inventory-integration "Direct link to heading")
...
#### Inventory Pull [REQUIRED][​](#inventory-pull-required "Direct link to heading")
...
### Store Hours Integration[​](#store-hours-integration "Direct link to heading")
...
#### Store Hours Pull [REQUIRED][​](#store-hours-pull-required "Direct link to heading")
...
### Orders Integration[​](#orders-integration "Direct link to heading")
...
#### Mandatory Orders Integration Features[​](#mandatory-orders-integration-features "Direct link to heading")
...
#### Optional Orders Integration Features[​](#optional-orders-integration-features "Direct link to heading")
...
### Useful Additional Features[​](#useful-additional-features "Direct link to heading")

#### Store Temporary Deactivation[​](#store-temporary-deactivation "Direct link to heading")
...
#### Item Level Promotions **[RECOMMENDED]**[​](#item-level-promotions-recommended "Direct link to heading")
...
## Store Onboarding Process[​](#store-onboarding-process "Direct link to heading")
...
## Merchant Enablement Material[​](#merchant-enablement-material "Direct link to heading")
...
## Certification[​](#certification "Direct link to heading")
...
## Pre-launch Preparation[​](#pre-launch-preparation "Direct link to heading")
