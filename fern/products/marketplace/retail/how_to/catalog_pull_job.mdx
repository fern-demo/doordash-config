...
### Step 1: Set up Endpoint Specification to Pull Catalog[​](#step-1-set-up-endpoint-specification-to-pull-catalog "Direct link to heading")
...
### Step 2: Ensure that items.json response from endpoint has the correct format[​](#step-2-ensure-that-itemsjson-response-from-endpoint-has-the-correct-format "Direct link to heading")
